                            ...
                            >
                                <div className="glass-card rounded-2xl p-8 h-full">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <h2 className="font-heading text-2xl font-semibold text-snow">Contact Information</h2>
                                    </div>
                                    <div className="space-y-4">
                                        <div>
                                            <p className="font-semibold text-snow mb-1">Laneway India Enterprises Private Limited</p>
                                            <div className="flex items-start gap-2 text-pumice text-sm">
                                                <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-gold" />
                                                <span>1087 B, Sankranthi, Perumbaikkad<br />Kottayam – 686016, Kerala, India</span>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2 text-pumice">
                                                <Mail className="w-4 h-4 text-gold" />
                                                <a href="mailto:info@laneway.in" className="text-gold hover:text-gold-light transition-colors">
                                                    info@laneway.in
                                                </a>
                                            </div>
                                            <div className="flex items-center gap-2 text-pumice">
                                                <Phone className="w-4 h-4 text-gold" />
                                                <a href="tel:+919961348942" className="text-gold hover:text-gold-light transition-colors">
                                                    +91 99613 48942
                                                </a>
                                            </div>
                                            <div className="text-pumice text-sm">
                                                <strong className="text-snow">GST:</strong> 32AAGCL2491R1Z0
                                            </div>
                                        </div>
                                    </div>
                                </div>
