      ...
      <motion.div style={{ opacity, y }} className="relative z-10 mx-auto max-w-5xl px-6 sm:px-8 lg:px-12">
        <div className="text-center">
          ...
          <motion.h2
            ...
            className="font-heading text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-medium text-snow mb-10 tracking-tight"
          >
            Laneway
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-pumice max-w-2xl mx-auto leading-relaxed font-light"
          >
            A premium digital agency pioneering the future of business through innovative technology and transformative
            solutions.
          </motion.p>
        </div>
      </motion.div>
