      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 sm:px-8 lg:px-12">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className="text-xs tracking-premium uppercase text-pumice">Our Work</span>
            <div className="w-12 h-px bg-gold/30" />
          </div>
          ...
          <p className="text-lg sm:text-xl text-pumice max-w-2xl mx-auto text-pretty font-light leading-relaxed">
            Discover how we have helped businesses overcome challenges and achieve remarkable results.
          </p>
        </motion.div>
      </div>
    </section>
