...
const partners = ["TechCorp", "InnovateLabs", "FutureScale", "DigitalFirst", "CloudNine", "DataDriven"]
    ...
    <section className="py-24 border-y border-glass-border overflow-hidden relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className="font-heading text-3xl sm:text-4xl font-medium text-snow">Our Partners</h2>
        </motion.div>
