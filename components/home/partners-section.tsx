        ...
        <div className="relative">
          ...
          >
            {[...partners, ...partners, ...partners, ...partners].map((partner, index) => (
              <div
                key={index}
                className="shrink-0 flex items-center justify-center h-12 px-6 sm:h-16 sm:px-10 glass-card rounded-full transition-all duration-500 hover:border-gold/20"
              >
